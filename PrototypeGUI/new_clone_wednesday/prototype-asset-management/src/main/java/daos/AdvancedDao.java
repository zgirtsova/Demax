...
public abstract class AdvancedDao<T> extends BaseDao<T> {
    ...
    public List<T> getAll() {
        ...
        String query = "SELECT * FROM " + super.getTableName();
        ...
        return this.getList(preparedStatement);
    }
    ...
    private List<T> getList(PreparedStatement preparedStatement) {
    ...
    protected int getCountByFilterParam(String param, int id) {
        ...
        try {
            ...
            connection = ConnectionPoolSingleton.getInstance().getCurrConn();
