					...
					<div class="history">
						...
						<% for(int i = 0; i < lastActions.size(); i++) { %>
							<% 
								...
								String[] dateTime = action.getDate().format(formatter).split(" ");
							%>
							<div class="row">
								...
								<div class="action">
									<i class="user"></i>
									<p><span>Kamen N</span> <%= action.getAction() %></p>
								</div>
							</div>
						<% } %>
					</div>
